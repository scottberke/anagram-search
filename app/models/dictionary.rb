...
#
#     if self.anagrams.has_key?(key)
#       self.add_anagram_to_correct_set(key, word)
#     else
#       self.anagrams[key] = { :proper => Set.new, :non_proper => Set.new }
#       self.add_anagram_to_correct_set(key, word)
#     end
#
#     update_stats(word)
#   end
#
#   def add_anagram_to_correct_set(key, word)
#     if word[0] == word[0].capitalize
#       self.anagrams[key]["proper"].add(word)
#     else
#       self.anagrams[key]["non_proper"].add(word)
#     end
#   end
#   # def ingest_from_file2(path:)
#   #   IO.foreach(path) do |word|
